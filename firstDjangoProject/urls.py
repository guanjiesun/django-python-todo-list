...
urlpatterns = [
    ...
    # TODO goods.urls 表示导入 goods 这个 package 的 urls 模块(urls.py)
    # TODO freight/ 表示给所有 goods 相关的 URL 加一个统一的前缀 freight/
    # TODO namespace 是 URL 名称的命名空间，它是 Django 为了解决多 app 中 URL 名字冲突、方便反向解析设置的机制
